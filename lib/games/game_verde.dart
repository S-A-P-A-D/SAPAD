...
class SnakeGameVerde extends StatefulWidget {
  @override
  _SnakeGameVerdeState createState() => _SnakeGameVerdeState();
}

class _SnakeGameVerdeState extends State<SnakeGameVerde> {
