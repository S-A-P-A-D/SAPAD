...
class SnakeGameAmarelo extends StatefulWidget {
  @override
  _SnakeGameAmareloState createState() => _SnakeGameAmareloState();
}

class _SnakeGameAmareloState extends State<SnakeGameAmarelo> {
